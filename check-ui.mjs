...
await page.click('#tab-workflow');await page.click('[data-work-scenario="2"]');await page.fill('#editor-text','<h1>My first build</h1>');await page.click('#editor-save');await page.fill('#work-command', 'make build');await page.locator('#work-command').press('Enter');await page.fill('#work-command', 'make build');await page.locator('#work-command').press('Enter');assert.match(await page.locator('#work-output').innerText(),/up to date/);await page.fill('#work-command', 'make serve');await page.locator('#work-command').press('Enter');assert.equal(await page.frameLocator('#work-preview').locator('h1').innerText(),'My first build');assert.match(await page.locator('#work-feedback').innerText(),/Complete/);
